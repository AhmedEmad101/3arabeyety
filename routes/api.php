...
//////////////////////////////////////////////////////////////////
route::get('user/{id}',action: [UserController::class,'User']);
//////////////////////////////
...
Route::get('iii/{vehicle}',[GeneralController::class,'index'])->middleware('auth:sanctum');
//Route::get('iii/{vehicle}',[GeneralController::class,'index'])->can('delete','vehicle');
