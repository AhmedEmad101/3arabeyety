        ...
        <div class="row g-5">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-7">
                            <div class="d-flex align-items-center">
                                <img src="img/ahmed.jpg" class="img-fluid rounded-circle border border-4 border-secondary" style="width: 100px; height: 100px;" alt="Image">
                                <div class="ms-4">
                                    <h4>Ahmed Emad</h4>
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="about-img">
                    ...
                    <div class="img-2">
                        <img src="img/images.jfif" class="img-fluid rounded w-100" alt="">
                    </div>
                </div>
            </div>
        </div>
